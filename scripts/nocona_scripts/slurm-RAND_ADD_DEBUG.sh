...
cd /home/brodwill/circustent_rand_debug/build/bin
...
mpirun -display-map --hostfile $HOSTFILE -mca coll ^hcoll --mca osc ^ucx --mca pml ^ucx -np $TOTAL_PES circustent -b $TEST -m 2147483648 -p $TOTAL_PES -i 100000
